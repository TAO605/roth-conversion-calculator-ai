...
export default function HomePage() {
  ...
  return (
    <main className="mx-auto grid w-full max-w-7xl gap-8 px-4 py-6 sm:px-6 lg:px-8">
      ...
      <header className="grid gap-4 pt-4">
        <nav className="flex flex-wrap items-center justify-between gap-3 rounded-[18px] bg-white/65 px-4 py-3 text-sm shadow-sm backdrop-blur-xl dark:bg-white/10">
          <Link className="font-semibold text-neutral-950 dark:text-white" href="/">
            RothCalc
          </Link>
          <div className="flex flex-wrap items-center gap-3 text-neutral-600 dark:text-neutral-300">
            <div className="flex flex-wrap gap-3">
              ...
              <Link className="hover:text-systemBlue" href="/accessibility-audit">
                Access
              </Link>
              <Link className="hover:text-systemBlue" href="/tax-data-update">
                Tax Data
              </Link>
              <Link className="hover:text-systemBlue" href="/ai-compliance-audit">
                AI Audit
              </Link>
              <Link className="hover:text-systemBlue" href="/content-operations">
                Content Ops
              </Link>
              <Link className="hover:text-systemBlue" href="/cpa-review-checklist">
                CPA
              </Link>
              <Link className="hover:text-systemBlue" href="/feedback-roadmap">
                Feedback
              </Link>
              <Link className="hover:text-systemBlue" href="/privacy-data-flow">
                Data Flow
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-planning-checklist">
                Checklist
              </Link>
              <Link className="hover:text-systemBlue" href="/calculator-assumptions-guide">
                Assumptions
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-mistakes">
                Mistakes
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-tax-forms">
                Forms
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-timeline">
                Timeline
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-custodian-process">
                Custodian
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-cpa-questions">
                CPA Questions
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-5-year-rules">
                5-Year
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-rmd-guide">
                RMD
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-social-security-tax-guide">
                Social Security
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-irmaa-guide">
                IRMAA
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-aca-premium-tax-credit-guide">
                ACA PTC
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-niit-guide">
                NIIT
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-capital-gains-guide">
                Gains
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-estimated-tax-guide">
                Est. Tax
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-recharacterization-guide">
                Rechar
              </Link>
              <Link className="hover:text-systemBlue" href="/roth-conversion-qcd-guide">
                QCD
              </Link>
              <Link className="hover:text-systemBlue" href="/site-index">
                Index
              </Link>
              <Link className="hover:text-systemBlue" href="/about">
                About
              </Link>
            </div>
      ...
      <section className="grid gap-5 lg:grid-cols-[0.95fr_1.05fr]" id="calculator">
        <Card>
          <div className="mb-5">
      ...
      <footer className="border-t border-neutral-200 py-6 text-xs leading-5 text-neutral-500 dark:border-white/10 dark:text-neutral-400">
