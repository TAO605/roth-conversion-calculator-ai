...
export const metadata = {
  ...
  description:
    "Educational Roth conversion ACA premium tax credit guide explaining Marketplace income estimates, Roth conversion income, advance premium tax credit reconciliation, Form 1095-A, Form 8962, coverage details, and calculator boundaries.",
  alternates: { canonical: "/roth-conversion-aca-premium-tax-credit-guide" },
};

export default function RothConversionAcaPremiumTaxCreditGuidePage() {
  ...
  return (
    <main className="mx-auto grid max-w-6xl gap-8 px-4 py-10">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbJsonLd([
              ...
              {
                name: "Roth Conversion ACA Premium Tax Credit Guide",
      ...
      <nav className="flex flex-wrap gap-2 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        <span>/ ACA premium tax credit guide</span>
      </nav>
      ...
      <section className="rounded-[20px] bg-white/75 p-5 shadow-material dark:bg-white/10">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            ...
            href="/tax-interactions/aca-premium-tax-credit"
          >
            Open ACA limits page
          </Link>
          <a
            className="rounded-full border border-neutral-300 px-4 py-2 text-sm font-semibold text-neutral-700 hover:text-systemBlue dark:border-white/15 dark:text-neutral-200"
