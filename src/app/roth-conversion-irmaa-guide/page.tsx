...
export const metadata = {
  ...
  description:
    "Educational Roth conversion IRMAA guide explaining Medicare income-related monthly adjustment amounts, conversion income and MAGI review, lookback years, life-changing events, Part B and Part D premiums, and calculator boundaries.",
  alternates: { canonical: "/roth-conversion-irmaa-guide" },
};

export default function RothConversionIrmaaGuidePage() {
  ...
  return (
    <main className="mx-auto grid max-w-6xl gap-8 px-4 py-10">
      ...
      <nav className="flex flex-wrap gap-2 text-sm text-neutral-500 dark:text-neutral-400">
        ...
        <span>/ IRMAA guide</span>
      </nav>

      <header className="rounded-[22px] bg-white/75 p-6 shadow-material backdrop-blur-xl dark:bg-white/10">
        <p className="text-sm font-semibold uppercase tracking-[0.12em] text-systemBlue">Medicare premium education</p>
      ...
      <section className="rounded-[20px] bg-white/75 p-5 shadow-material dark:bg-white/10">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            ...
            href="/tax-interactions/irmaa"
          >
            Open IRMAA limits page
          </Link>
          <a
            className="rounded-full border border-neutral-300 px-4 py-2 text-sm font-semibold text-neutral-700 hover:text-systemBlue dark:border-white/15 dark:text-neutral-200"
