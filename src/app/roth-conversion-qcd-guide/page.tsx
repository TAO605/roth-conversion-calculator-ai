...
export const metadata = {
  ...
  description:
    "Educational Roth conversion QCD guide explaining qualified charitable distributions, RMD coordination, why QCDs are not Roth conversions, recordkeeping, Form 1099-R review, charity acknowledgments, and calculator boundaries.",
  alternates: { canonical: "/roth-conversion-qcd-guide" },
};

export default function RothConversionQcdGuidePage() {
    ...
    <main className="mx-auto grid max-w-6xl gap-8 px-4 py-10">
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify(
            breadcrumbJsonLd([
              ...
              { name: "Roth Conversion QCD Guide", path: "/roth-conversion-qcd-guide" },
            ]),
          ),
        }}
      ...
      <header className="rounded-lg border border-neutral-200 bg-white p-6 dark:border-white/10 dark:bg-neutral-950">
        ...
        <p className="mt-4 max-w-3xl text-lg leading-8 text-neutral-600 dark:text-neutral-300">
          Educational guide for users comparing qualified charitable distributions, RMDs, and Roth conversions. It
          explains why QCDs should not be entered as Roth conversion amounts and why charitable giving strategy is
