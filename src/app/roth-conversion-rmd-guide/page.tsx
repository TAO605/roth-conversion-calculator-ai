...
export const metadata = {
  ...
  description:
    "Educational Roth conversion RMD guide explaining required minimum distribution basics, conversion sequence review, Roth IRA owner treatment, inherited account rules, calculator boundaries, and professional review records.",
  alternates: { canonical: "/roth-conversion-rmd-guide" },
};

export default function RothConversionRmdGuidePage() {
  ...
  return (
    <main className="mx-auto grid max-w-6xl gap-8 px-4 py-10">
      ...
      <header className="rounded-[22px] bg-white/75 p-6 shadow-material backdrop-blur-xl dark:bg-white/10">
        <p className="text-sm font-semibold uppercase tracking-[0.12em] text-systemBlue">RMD education</p>
      ...
      <section className="rounded-[20px] bg-white/75 p-5 shadow-material dark:bg-white/10">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            ...
            href="/tax-interactions/rmds"
          >
            Open RMD limits page
          </Link>
          <Link
            className="rounded-full border border-neutral-300 px-4 py-2 text-sm font-semibold text-neutral-700 hover:text-systemBlue dark:border-white/15 dark:text-neutral-200"
