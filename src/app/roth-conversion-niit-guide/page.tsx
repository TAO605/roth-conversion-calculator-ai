...
export const metadata = {
  ...
  description:
    "Educational Roth conversion NIIT guide explaining net investment income tax basics, Roth conversion income and MAGI review, investment income classification, Form 8960 review, and calculator boundaries.",
  alternates: { canonical: "/roth-conversion-niit-guide" },
};

export default function RothConversionNiitGuidePage() {
      ...
      <section className="rounded-lg border border-neutral-200 bg-white p-5 dark:border-white/10 dark:bg-neutral-950">
        ...
        <div className="mt-5 flex flex-wrap gap-3">
          ...
          <Link
            ...
            href="/tax-interactions/niit"
          >
            Open NIIT limits page
          </Link>
          <a
            className="rounded-full border border-neutral-300 px-4 py-2 text-sm font-semibold text-neutral-700 hover:text-systemBlue dark:border-white/15 dark:text-neutral-200"
